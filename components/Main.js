  ...
  return (
    <section class="text-black body-font lg:pt-20">
      ...
      <div class="container flex flex-col items-center justify-center py-8 mx-auto rounded-lg md:p-1 p-3">
        <img
          class="object-cover object-center w-full mb-10 border-gray-200 dark:border-gray-800 g327 border rounded-lg shadow-md"
          alt="hero"
          ...
          <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-wrap -m-4 text-center">
              <div class="p-4 sm:w-1/3 w-1/2">
                ...
                <p class="leading-relaxed">Volunteer in community events, environment protection, and education outreach.</p>
              </div>
              <div class="p-4 sm:w-1/3 w-1/2">
                <h2 class="title-font font-medium sm:text-5xl text-3xl text-white">
                ...
                <p class="leading-relaxed">Visits & talks </p>
              </div>
              <div class="p-4 sm:w-1/3 w-1/2">
                ...
                <p class="leading-relaxed">Member</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div class="flex flex-wrap -m-4">
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                      ...
                      <h3 class="text-gray-500 mb-3">Vartix</h3>
                      <p class="mb-4">
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                      <h2 class="title-font font-medium text-lg text-white">
                        Flyesky Rocketry Club
                      </h2>
                      <h3 class="text-gray-500 mb-3">Workshpo on glider Making</h3>
                      <p class="mb-4">
                        {/* Workshpo on glider Making  */}
                      </p>
                      <span class="inline-flex">
                        <a class="text-gray-500">
                          <svg
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                      ...
                      <h3 class="text-gray-500 mb-3">New Beginning</h3>
                      <p class="mb-4">
                        {/* Chris is part of our front-end team providing amazing
                        websites. */}
                      </p>
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    ...
                    <div class="w-full">
                      ...
                      {/* <h3 class="text-gray-500 mb-3">Workshpo</h3> */}
                      <p class="mb-4">
                        {/* Chris is part of our front-end team providing amazing
                        websites. */}
                      </p>
